      ...
      >
        {toasts.map((toast) => (
          <div
            ...
            aria-atomic="true"
            className="animate-toast-in pointer-events-auto flex w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] shrink-0 items-start gap-3 rounded-lg border border-gray-200/80 bg-white p-3 sm:w-auto sm:min-w-[320px] sm:max-w-md dark:border-white/10 dark:bg-gray-900"
          >
            <div
